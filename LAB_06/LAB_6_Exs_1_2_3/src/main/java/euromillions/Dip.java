...
public class Dip {
    ...
    private static final int maxStart = 9;
    private static final int maxNumberOfStarts = 2; //número que estava previamente no código
    private static final int maxNumber = 49;
    private static final int maxNumberOfNumbers = 5;  //número que estava previamente no código
    ...
    public Dip(int[] arrayOfNumbers, int[] arrayOfStarts) {
        ...
        if (maxNumberOfNumbers == arrayOfNumbers.length && maxNumberOfStarts == arrayOfStarts.length) {
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < maxNumberOfNumbers; ) {
        ...
        for (int i = 0; i < maxNumberOfStarts; ) {
            int candidate = generator.nextInt(maxStart) + 1;
